...
const Setting = () => {
  ...
  // 使用 searchParams 的 "section" 参数管理当前 section，避免与 createHashRouter 的 hash 冲突
  const sectionParam = searchParams.get("section");
  const selectedSection: SettingSectionKey =
    sectionParam && isSettingSectionKey(sectionParam) && visibleSectionKeys.has(sectionParam)
      ? sectionParam
      : DEFAULT_SETTING_SECTION;
